    ...
    <div class="container mx-auto text-black">
        @if (session('message'))
            <div class="alert alert-error">
                ...
                <span>Error! Nama sudah digunakan</span>
            </div>
        @endif
        <div class="flex mt-2 mb-4 justify-between gap-3">
            <div class="flex flex-col bg-white w-full p-4 rounded-md border border-slate-300">
                <span class="text-xl">Nasabah</span>
        ...
        <div class="flex flex-col w-full bg-white p-4 rounded-lg h-full border border-slate-300">
            <div class="flex justify-between">
                <div class="flex gap-2 items-center mb-5">
                    <span class="text-lg">Filter By</span>
                    <select name="" id="" class="border rounded p-2 px-3 bg-white">
                        <option value="">ascending</option>
                        <option value="">descending</option>
                    </select>
                </div>
                <div class="flex gap-2 items-center">
                    <a href="#my_modal_add" class="btn btn-success">Add User</a>
                    <a href="#my_modal_trash" class="btn btn-error">Trash</a>
                </div>
                <div class="modal bg-white" id="my_modal_trash">
                    <div class="modal-box bg-white">
                        <div class="flex flex-col w-full">
                            ...
                            @foreach ($user_deleted as $pdl)
                                <div class="flex justify-between items-center">
                                    <span>{{ $pdl->name }}</span>
                                    <div class="flex gap-2">
                                        <form action="/user-admin-restore/{{ $pdl->id }}" method="post">
                                            @csrf
                                        ...
                                        <form action="/user-admin-trash/{{ $pdl->id }}" method="post">
                                            @csrf
                                            @method('DELETE')
                    ...
                    <div class="modal-box">
                        <div class="flex flex-col w-full">
                            ...
                            <form action="{{ route('storeUser') }}" method="post" enctype="multipart/form-data"
                                ...
                                @csrf
                                <span>Name</span>
                                <input type="text" name="name" class="mb-2 w-full input input-bordered" required>
                                <span>Password</span>
                                <input type="text" name="password" class="mb-2 w-full input input-bordered" required>
                                <span>Role</span>
                                <select name="roles_id" class="select w-full max-w-xs input input-bordered mb-2">
                            ...
                            <tr class="border-b border-gray-200">
                                ...
                                <td class="p-2 text-center">
                                    <div class="flex justify-center items-center gap-2">
                                        ...
                                        <a href="#my_modal_{{ $user->id }}" class="btn btn-warning">Edit</a>
                                        <div class="modal" id="my_modal_{{ $user->id }}">
                                            <div class="modal-box">
                                                <div class="flex flex-col w-full">
                                                    ...
                                                    <form action="/user-admin-update/{{ $user->id }}" method="post"
                                                        ...
                                                        <input type="text" value="{{ $user->name }}" name="name"
                                                            class="mb-2 w-full input input-bordered" required>
                                                        <span>Password</span>
                                                        <input type="text" name="password"
                                                            class="mb-2 w-full input input-bordered">
                                                        <span>Role</span>
                                                        <select name="roles_id"
                                                            class="select w-full max-w-xs input input-bordered mb-2">
                                                            @foreach ($roles as $role)
